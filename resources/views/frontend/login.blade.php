        ...
        <div id="container">
            <div id="main-content-wp" class="clearfix detail-blog-page">
                ...
                <div class="contact">
                    ...
                    <h3>Login</h3>
                    <form name="myForm" action="{{route('sign_in')}}" method="POST">
                        @csrf
                        <input type="email" name="email" placeholder="Email">
                        <input type="password" name="password" placeholder="Password">
                        <button style="margin: 0 !important;" type="submit">Send</button>
                        <a href="{{route('register')}}" class="btn btn-success btn-register" style="margin-top: 10px" type="submit">Đăng ký tài khoản</a>
                    </form>
                </div>
            </div>
        </div>
